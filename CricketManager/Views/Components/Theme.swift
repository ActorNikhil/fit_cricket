...
struct Theme {
    static let bg       = Color(hex: "#080c14")
    static let surface1 = Color(hex: "#0e1521")
    static let surface2 = Color(hex: "#131d2e")
    static let surface3 = Color(hex: "#1a2640")
    ...
    static let text     = Color(hex: "#e8eef8")
    static let text2    = Color(hex: "#7a90b8")
    static let text3    = Color(hex: "#3d5070")
